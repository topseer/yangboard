	...
	/* CROPPER */
      ...
      $('form').submit(function(e) {
	   ...
	   /* CUSTOM NOTIFICATION */
		...
		// leads by time of day			
						var ctx = document.getElementById("barChart_leadsVolume");						
...
//								},
			...
			//myself vs div AVG
			if ($('#Myself_VS_DivAvg').length ){ 				 
				var ctx = document.getElementById("Myself_VS_DivAvg");
				//ctx.height = 120;
			  var Myself_VS_DivAvg = new Chart(ctx, {
				type: 'bar',
				data: {
					labels: ["Leads","Opens","Pitches","AOs","Funds"],					
				  datasets: [{
					label: 'Top20%',
			...
			if ($('#canvasRadar').length ){ 
			  ...
			  var data = {
				...
				datasets: [{
				  ...
				  pointColor: "rgba(255, 128, 128, 0.5)",
