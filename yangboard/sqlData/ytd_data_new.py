...
def get_ytdData():  
  ...
  query = """  
 select a.PersonID,a.Employee_Code,lower(b.email) Email,
    ...
    from test_yang.dbo.AEMatrix_Report_1  as a 
    inner join  test_yang.dbo.topDownAELookupTable as b 
    on a.personid = b.PersonId    
    group by a.PersonID,a.Employee_Code,a.FstNm,a.LstNm,a.WaterFallDivision,a.Team_Desc  ,b.email         
  """
